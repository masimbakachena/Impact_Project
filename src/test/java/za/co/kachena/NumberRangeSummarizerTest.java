...
public class NumberRangeSummarizerTest {
    ...
    public void test_Collect(){
        ...
        Assert.assertEquals(List.of(1,4,5,4,6,5,7,6,5,7,6,7), numberRangeSummarizer.collect(input1));
        ...
        Assert.assertEquals(List.of(12,11,10,9,8,7,77,76,75,74,6,7), numberRangeSummarizer.collect(input4));
    }

    @Test
    public void test_SummarizeCollection(){
        Assert.assertEquals("1,4-5,4,6,5,7,6,5,7,6-7", numberRangeSummarizer.summarizeCollection(numberRangeSummarizer.collect(input1)));
        ...
        Assert.assertEquals("12,11,10,9,8,7,77,76,75,74,6-7", numberRangeSummarizer.summarizeCollection(numberRangeSummarizer.collect(input4)));
    }
